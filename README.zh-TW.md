...
一個專為現代 Go 應用程式設計的強大、具備 Context 感知的 NATS JetStream broker，提供無縫的 `go-fx` 整合與可靠的訊息處理。

[English Documentation](README.md)

## 設計理念

我們相信訊息基礎設施應該是可靠、透明且易於管理的。此 broker 建立在三個核心支柱之上：
...
此 broker 不讓 NATS 盲目地將訊息推送到您的服務，而是使用 **Pull Consumers**。
...
此 broker 實作了一個清晰的介面，將您的業務邏輯與底層 NATS 實作解耦。
